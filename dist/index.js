...
const a1 = new Assalariado_1.Assalariado('Ter Stegen', 'G026.893.940-30', 2500);
const c1 = new Comissionado_1.Comissionado('Dorval', '462.319.500-77', 20, 20);
const h1 = new Horista_1.Horista('Ronaldinho', '731.067.000-09', 39, 40);
